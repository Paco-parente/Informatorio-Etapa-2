...
#Dado un diccionario llamado stock que contiene productos como claves y una tupla con su precio y cantidad disponible como valor, escribí un programa que:
